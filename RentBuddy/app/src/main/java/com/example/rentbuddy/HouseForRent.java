...
public class HouseForRent extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_house_for_rent);
        ...
        final DatabaseReference myRef = database.getReference("house_rent_1");
        final DatabaseReference myRef2 = database.getReference("house_rent_2");
        final DatabaseReference myRef3 = database.getReference("house_rent_3");
        ...
        interested1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(HouseForRent.this, userInfo.class);
                HouseForRent.this.startActivity(myIntent);
        ...
        try{
            ...
            JSONArray jsonArray = obj.getJSONArray("houses");
            ...
            String price1="Price: "+hash1.get("price")+"/Day";
            ...
            String price2="Price: "+hash2.get("price")+"/Day";
            ...
            String price3="Price: "+hash3.get("price")+"/Day";
    ...
    public String loadJSONFromAsset() {
        String json = null;
        try {
            InputStream is = this.getAssets().open("house_for_rent.json");
