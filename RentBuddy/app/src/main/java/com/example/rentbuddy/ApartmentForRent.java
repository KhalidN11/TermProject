...
public class ApartmentForRent extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_apartment_for_rent);
        ...
        final DatabaseReference myRef = database.getReference("ap_rent_1");
        final DatabaseReference myRef2 = database.getReference("ap_rent_2");
        final DatabaseReference myRef3 = database.getReference("ap_rent_3");
        ...
        interested1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(ApartmentForRent.this, userInfo.class);
                ApartmentForRent.this.startActivity(myIntent);
            }
        });
        ...
        try{
            ...
            String price1="Price: "+hash1.get("price")+"/Month";
            ...
            String price2="Price: "+hash2.get("price")+"/Month";
            ...
            String price3="Price: "+hash3.get("price")+"/Month";
    ...
    public String loadJSONFromAsset() {
        String json = null;
        try {
            InputStream is = this.getAssets().open("app_for_rent.json");
