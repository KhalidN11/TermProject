...
public class HouseForSell extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_house_for_sell);


        final String s=loadJSONFromAsset();
        ...
        final DatabaseReference myRef = database.getReference("house_sell_1");
        final DatabaseReference myRef2 = database.getReference("house_sell_2");
        final DatabaseReference myRef3 = database.getReference("house_sell_3");
        ...
        interested1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(HouseForSell.this, userInfo.class);
                HouseForSell.this.startActivity(myIntent);
            }
        });
    ...
    public String loadJSONFromAsset() {
        String json = null;
        try {
            InputStream is = this.getAssets().open("house_for_sell.json");
